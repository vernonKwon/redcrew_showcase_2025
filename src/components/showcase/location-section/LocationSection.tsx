      ...
      <div className="location-section__container">
        <div className="location-section__header">
          <h2 className="location-section__title">
            <span className="location-section__title-highlight">오시는</span> 길
          </h2>
        ...
        <div className="location-section__content">
          ...
          <div className="location-section__info">
            <div className="location-section__info-card">
              <div className="location-section__info-icon">
                <MapPin size={24} />
              </div>
              <div className="location-section__info-content">
                <h3 className="location-section__info-title">주소</h3>
                <p className="location-section__info-text">
                  서울 중랑구 면목로 238
                  <br />
            ...
            <div className="location-section__info-card">
              ...
              <div className="location-section__info-content">
                <h3 className="location-section__info-title">대중교통</h3>
                <p className="location-section__info-text">
                  <span className="location-section__subway">지하철 7호선</span>{' '}
                  용마산역 1번 출구
                  <br />
                  도보 약 5분
                </p>
            ...
            <div className="location-section__info-card">
              ...
              <div className="location-section__info-content">
                <h3 className="location-section__info-title">주차 안내</h3>
                <p className="location-section__info-text">
                  • 용마폭포공원 공영주차장
                  <br />
                  • 중곡초등학교 공영주차장
                  <br />
                  <span className="location-section__parking-note">
