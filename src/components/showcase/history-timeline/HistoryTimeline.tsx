  ...
  const timelineEvents: TimelineEvent[] = [
    {
      ...
      title: '레드크루 결성',
      description:
        "열정, 경고, 개성을 표현할 때 제일 눈에 띄는 컬러인 '레드'처럼 각자 매력이 있는 멤버들이 버스킹 활동을 하는 팀을 결성",
      side: 'left',
    },
    {
      year: '2016',
      title: '찬조공연, 외부활동',
      description:
        '중학교, 고등학교 등 수도권 전 지역에서 행사 및 공연 활동, 새로운 도전의 시작점',
      side: 'right',
    },
    {
      year: '2019',
    ...
    },
    {
      ...
      title: '프로젝트 전환',
      description:
        '코로나 시기, 버스킹과 행사 등을 할 수 없게 되었을 때 유튜브 커버댄스 촬영팀으로 전환',
      side: 'right',
    },
    {
      year: '2023',
      title: '전성기',
      description:
        '마포구청, 서초구청, 초/중/고 등 공공기관에서 러브콜 쇄도, 유튜브/버스킹/찬조 등 다방면에서 화려하게 활동',
      side: 'left',
    },
    {
      year: '2025',
