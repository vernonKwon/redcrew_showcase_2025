  ...
  return (
    <div className="container" style={{ padding: '2rem' }}>
      ...
      >
        <h3>🏗️ 빌드 정보</h3>
        <p>
          <strong>빌드 시간:</strong> {buildTime}
        </p>
        <p style={{ fontSize: '0.9rem', color: '#666', marginTop: '0.5rem' }}>
          ⚠️ 이 시간은 빌드할 때 한 번만 생성되며, 새로고침해도 변경되지
          않습니다.
        </p>
          ...
          {articles.map((article) => (
            <div
              ...
              style={{
                ...
                cursor: 'pointer',
                background:
                  selectedArticle?.id === article.id ? '#fff9e6' : '#fff',
                transition: 'all 0.3s',
              }}
            >
      ...
      {selectedArticle && (
        ...
        >
          ...
          <p>
            &quot;{selectedArticle.title}&quot; by {selectedArticle.author}
          </p>
      ...
      >
        ...
        <ol style={{ marginTop: '0.5rem' }}>
          ...
          <li>
            yarn build 후 yarn start로 실행하면 실제 SSG 동작을 확인할 수
            있습니다
          </li>
        </ol>
      </div>
  ...
  const articles: Article[] = [
    {
      ...
      content:
        'Next.js 14에서는 Turbopack이 안정화되고, Server Actions가 정식 지원됩니다. 개발 서버 시작 속도가 획기적으로 개선되었습니다.',
      author: '김개발',
    ...
    },
    {
      ...
      content:
        'RSC는 서버에서 렌더링되는 React 컴포넌트입니다. 번들 크기를 줄이고 성능을 향상시킬 수 있는 새로운 패러다임입니다.',
      author: '이리액트',
    ...
    },
    {
      ...
      content:
        '데코레이터가 정식 지원되고, const type parameters가 추가되었습니다. 타입 추론이 더욱 강력해졌습니다.',
      author: '박타입',
    ...
    },
    {
      ...
      content:
        '유틸리티 우선 CSS와 CSS-in-JS 방식의 장단점을 비교합니다. 프로젝트 특성에 맞는 선택이 중요합니다.',
      author: '최스타일',
